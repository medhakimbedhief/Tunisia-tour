        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>GR</li>
...
?>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" <?php echo("href=../FRONT/Controller/editR.php?id=" .$rows['id']." ") ?>><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-success" href="#"><i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" <?php echo("href=../FRONT/Controller/deleteR.php?id=" .$rows['id']." ") ?> ><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
