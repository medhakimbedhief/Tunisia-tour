      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
              ...
              <ul class="sub">
                <li>
                  <a class="active" href="checkout_region.php">region</a>
                </li>
                <li>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-4">
      <h3 class="text-center text-info">Add region</h3>
            <hr>
<form class="was-validated" action="Ajouterregion.php" method="POST" >


<div class="form-group">
<input type="text" name="nom" class="form-control" required pattern="[0-9a-zA-Z,/.]{3,12}" placeholder="Enter Name Of the region" >
</div>
...
$region1c=new regionc();
$listeregion=$region1c->afficherregion();
...
foreach($listeregion as $row){
    if($row['DateFin']<$today)
    {
        $region1c->supprimerregion($row['idR']);
    }
}
$listeregion=$region1c->afficherregion();
    ?>
...
foreach($listeregion as $row){
  ...
  <td><?PHP echo $row['nomRegion']; ?></td>
  <td><?PHP echo $row['description']; ?></td>

  <td><img width="80" src="uploads/<?php echo $row['photo'] ?>" alt="<?php echo $row['photo'] ?>"></td>
 
 <td style="width="70% ><form method="POST" action="supprimerregion.php" >
            <input type="submit" name="delete" value="Delete" class="btn btn-danger btn-block" >
                         <input type="hidden" value="<?php echo $row['id']; ?>" name="id" >
                         </form>
                        </td>
                         <td><a class="btn btn-success btn-block" href="modifierregion.php?id=<?PHP echo $row['id']; ?>">
  Modifier</a></td>     
