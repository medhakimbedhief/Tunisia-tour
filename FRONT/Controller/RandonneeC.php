 ...
 include "./Models/Randonnee.php"; 
  class RandonneeC {
    ...
    function modifierrandonnee($randonnee,$id){
		$sql="UPDATE randonnee SET id=:idd, nom=:nom, region=:region, date=:date,description=:description, photo=:photo , cout=:cout WHERE id=:id";
...
try{		
		...
		$datas = array(':idd'=>$idd,':id'=>$id,  ':nom'=>$nom, ':region'=>$region,':date'=>$date, ':photo'=>$photo, 'description'=>$description, 'cout'=>$cout );
